...
ДНИ ПОДРЯД. Длина серии дней берётся только из поля streak — считать её по количеству дней в history нельзя. Она всегда пишется словом («второй день», «третий день подряд»), никогда цифрой — рядом со словами «день», «дня», «сутки» не должно быть цифры вообще, ни верной, ни любой другой.
